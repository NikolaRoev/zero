...
export default function WorkPage({ id }: { id: number }) {
    ...
    function handleNameChange(work: Work, value: string) {
    ...
    function handleProgressChange(work: Work, value: string) {
    ...
    function handleStatusChange(work: Work, value: string) {
    ...
    function handleTypeChange(work: Work, value: string) {
    ...
    function handleFormatChange(work: Work, value: string) {
        ...
        work && <div className="grow p-[5px] flex flex-col gap-y-[10px]">
            <div className="p-[5px] grid grid-cols-9 gap-x-[40px] gap-y-[5px] border border-neutral-700 rounded">
                ...
                <Input
                    ...
                    value={work.name}
                    placeholder="Name"
                    onChange={(event) => { handleNameChange(work, event.target.value); } } />
                <label>Progress:</label>
                <Input
                    className="col-span-8"
                    value={work.progress}
                    placeholder="Progress"
                    onChange={(event) => { handleProgressChange(work, event.target.value); } } />
                <label>Status:</label>
                <Select
                    className="col-span-2"
                    value={work.status}
                    items={statuses.map((status) => ({ label: status.status, value: status.status }))}
                    onChange={(value) => { handleStatusChange(work, value); } }
                ...
                <Select
                    ...
                    onChange={(value) => { handleTypeChange(work, value); } }
                ...
                <Select
                    ...
                    onChange={(value) => { handleFormatChange(work, value); } }
